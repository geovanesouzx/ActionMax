    ...
    function renderAvatarSelectionPage() {
        ...
        allAvatars.forEach(category => {
            ...
            (category.avatars || []).forEach(avatarUrl => {
                ...
                if (currentUserData && currentUserData.avatarUrl === avatarUrl) {
                ...
                avatarChoice.addEventListener('click', async () => {
                    document.querySelectorAll('.avatar-choice.selected').forEach(el => el.classList.remove('selected'));
                    avatarChoice.classList.add('selected');
                    ...
                    try {
                        ...
                        avatarChoice.classList.remove('selected');
                    }
                });
